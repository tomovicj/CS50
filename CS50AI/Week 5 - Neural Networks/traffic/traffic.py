...
def load_data(data_dir):
    ...
    for label in range(NUM_CATEGORIES):
        categorie_path = os.path.join(data_dir, str(label))
        categorie_files = os.listdir(categorie_path)
        for img_file_name in categorie_files:
            img_path = os.path.join(categorie_path, img_file_name)
